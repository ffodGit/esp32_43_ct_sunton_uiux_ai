...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff16213e), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            apply_style_dark_theme_claude00_title(obj);
        ...
        }
        {
            ...
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_dark_theme_claude01_button(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
...
void create_screen_screen01() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff16213e), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_arc_color(obj, lv_color_hex(0xff163460), LV_PART_INDICATOR | LV_STATE_DEFAULT);
...
void create_screen_screen03() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff16213e), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff163460), LV_PART_ITEMS | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_style_text_color(obj, lv_color_hex(0xff163460), LV_PART_MAIN | LV_STATE_DEFAULT);
        }
    }
