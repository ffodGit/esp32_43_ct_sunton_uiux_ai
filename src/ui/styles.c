...
void apply_style_dark_theme_claude00_title(lv_obj_t *obj) {
    lv_obj_set_style_text_font(obj, &lv_font_montserrat_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(obj, lv_color_hex(0xffe94560), LV_PART_MAIN | LV_STATE_DEFAULT);
};
void apply_style_dark_theme_claude01_button(lv_obj_t *obj) {
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff163460), LV_PART_MAIN | LV_STATE_DEFAULT);
